...
xcopy "References\Conditional\Steamworks\OSX-Linux-x64\steam_api.bundle" "src\IronyModManager\bin\x64\Release\net6.0\publish\osx-x64\steam_api.bundle\" /S /E /H
cd publish