...
dotnet publish src\IronyModManager.GameLauncher\IronyModManager.GameLauncher.csproj  /p:PublishProfile=src\IronyModManager.GameLauncher\Properties\PublishProfiles\osx-x64.pubxml --configuration osx-x64
...
xcopy "src\IronyModManager.GameLauncher\bin\x64\osx-x64\net6.0\publish\osx-x64\*.*" "src\IronyModManager\bin\x64\osx-x64\net6.0\publish\osx-x64\" /Y /S /D
