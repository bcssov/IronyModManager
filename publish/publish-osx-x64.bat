cd ..
dotnet publish src\IronyModManager.Updater\IronyModManager.Updater.csproj  /p:PublishProfile=src\IronyModManager.Updater\Properties\PublishProfiles\osx-x64 --configuration Release
...
xcopy "src\IronyModManager.Updater\bin\Release\netcoreapp3.1\publish\osx-x64\*.*" "src\IronyModManager\bin\Release\netcoreapp3.1\publish\osx-x64\" /Y /S /D
