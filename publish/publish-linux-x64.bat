...
dotnet publish src\IronyModManager.GameLauncher\IronyModManager.GameLauncher.csproj  /p:PublishProfile=src\IronyModManager.GameLauncher\Properties\PublishProfiles\linux-x64.pubxml --configuration linux-x64
...
xcopy "src\IronyModManager\bin\linux-x64\net6.0\linux-x64\*.dll" "src\IronyModManager\bin\x64\linux-x64\net6.0\publish\linux-x64\" /Y /S /D
xcopy "src\IronyModManager\bin\linux-x64\net6.0\linux-x64\*.json" "src\IronyModManager\bin\x64\linux-x64\net6.0\publish\linux-x64\" /Y /S /D
xcopy "src\IronyModManager\bin\linux-x64\net6.0\linux-x64\*.pdb" "src\IronyModManager\bin\x64\linux-x64\net6.0\publish\linux-x64\" /Y /S /D
xcopy "src\IronyModManager.Updater\bin\x64\linux-x64\net6.0\publish\linux-x64\*.*" "src\IronyModManager\bin\x64\linux-x64\net6.0\publish\linux-x64\" /Y /S /D
xcopy "src\IronyModManager.GameLauncher\bin\x64\linux-x64\net6.0\publish\linux-x64\*.*" "src\IronyModManager\bin\x64\linux-x64\net6.0\publish\linux-x64\" /Y /S /D
...
del "src\IronyModManager\bin\x64\linux-x64\net6.0\publish\linux-x64\IronyModManager.GameLauncher.runtimeconfig.dev.json" /S /Q
