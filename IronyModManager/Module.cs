...
namespace IronyModManager
{
    ...
    public class Module : IModule
    {
        ...
        public IEnumerable<string> Dependencies => new List<string> { typeof(Common.Module).Namespace, typeof(DI.Module).Namespace, typeof(Models.Common.Module).Namespace, typeof(Services.Common.Module).Namespace };
