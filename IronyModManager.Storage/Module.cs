...
namespace IronyModManager.Storage
{
    ...
    public class Module : IModule
    {
        ...
        public IEnumerable<string> Dependencies => new List<string> { typeof(Models.Common.Module).Namespace, typeof(Common.Module).Namespace,
            typeof(DI.Module).Namespace, typeof(Shared.Module).Namespace };
