...
namespace IronyModManager.Storage
{
    ...
    public class Module : IModule
    {
        ...
        public IEnumerable<string> Dependencies => new List<string> { typeof(Models.Common.Module).Name, typeof(Common.Module).Name,
            typeof(DI.Module).Name, typeof(Shared.Module).Name };
