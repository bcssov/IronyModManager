...
namespace IronyModManager.Implementation.Themes
{
    ...
    public class MaterialLightTheme : BaseThemeResources
    {
        ...
        public override IReadOnlyCollection<string> Styles => new List<string>() { "avares://IronyModManager/Controls/Themes/MaterialLight/Theme.axaml", "avares://Material.Icons.Avalonia/App.xaml", "avares://IronyModManager/Controls/Themes/MaterialLight/ThemeOverride.axaml" };
