...
namespace IronyModManager.Controls
{
    ...
    public class BoundClassTextBlock : TextBlock, IStyleable
    {
        #region Fields
        ...
        /// </summary>
        public static readonly StyledProperty<string> BoundClassesProperty = AvaloniaProperty.Register<BoundClassTextBlock, string>(nameof(BoundClasses));
