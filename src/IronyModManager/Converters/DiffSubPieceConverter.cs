...
// ***********************************************************************
// <copyright file="DiffSubPieceConverter.cs" company="Mario">
//     Mario
// </copyright>
// <summary></summary>
// ***********************************************************************
    ...
    public class DiffSubPieceConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            if (value is DiffPiece)
            {
                ...
                {
                    ChangeType.Unchanged => "DiffUnchangedPieces",
                    ChangeType.Deleted => "DiffDeletedPieces",
                    ChangeType.Inserted => "DiffInsertedPieces",
                    ChangeType.Modified => "DiffModifiedPieces",
                    _ => string.Empty,
                };
            }
            return string.Empty;
