...
// ***********************************************************************
// <copyright file="ParadoxModConverter.cs" company="Mario">
//     Mario
// </copyright>
// <summary></summary>
// ***********************************************************************
...
namespace IronyModManager.Converters
{
    ...
    public class ParadoxModConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            {
                return source == ModSource.Paradox;
            }
            return false;
        }
