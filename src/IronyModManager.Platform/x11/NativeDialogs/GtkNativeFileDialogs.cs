...
// ***********************************************************************
// <copyright file="GtkNativeFileDialogs.cs" company="Avalonia">
//     Avalonia
// </copyright>
...
namespace IronyModManager.Platform.x11.NativeDialogs
{
    ...
    internal class GtkSystemDialog : ISystemDialogImpl
    {
        ...
        /// </summary>
        /// <exception cref="Exception">Unable to initialize GTK on separate thread</exception>
        ...
        private void UpdateParent(IntPtr chooser, IWindowImpl parentWindow)
        {
