...
// ***********************************************************************
// <copyright file="LocalizationCollectionRefreshHandlerTests.cs" company="Mario">
//     Mario
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    /// <summary>
    /// Class LocalizationCollectionRefreshHandlerTests.
    /// </summary>
    public class LocalizationCollectionRefreshHandlerTests
    {
        /// <summary>
        ...
        /// <summary>
        /// Defines the test method Should_refresh_property.
        /// </summary>
        [Fact]
        ...
        public void Should_not_refresh_property()
        {
            ...
            DISetup.Container.Register<FakeModel>();
            var model = DISetup.Container.GetInstance<FakeModel>();
            model.Dummy3 = new List<FakeLocalizableModelWithoutAttribute>() { new FakeLocalizableModelWithoutAttribute()
            {
                FakeProp = "1"
            } };
            var changedEvents = new List<string>();
        ...
        public void Should_not_refresh_readonly_property()
        {
            ...
            DISetup.Container.Register<FakeModel>();
            var model = DISetup.Container.GetInstance<FakeModel>();
            model.Dummy4 = new List<FakeLocalizableWithReadonlyProperty>() { new FakeLocalizableWithReadonlyProperty() };
            var changedEvents = new List<string>();
            var changingEvents = new List<string>();
        ...
        private class FakeModel
        {
            ...
            public IEnumerable<FakeLocalizableModel> Dummy2 { get; set; }

            /// <summary>
            /// Gets or sets the dummy3.
            /// </summary>
            /// <value>The dummy3.</value>
            public IEnumerable<FakeLocalizableModelWithoutAttribute> Dummy3 { get; set; }

            /// <summary>
            /// Gets or sets the dummy4.
            /// </summary>
            /// <value>The dummy4.</value>
            public IEnumerable<FakeLocalizableWithReadonlyProperty> Dummy4 { get; set; }
        }
