...
// ***********************************************************************
// <copyright file="FastDefaultParser.cs" company="Mario">
//     Mario
// </copyright>
// <summary></summary>
// ***********************************************************************
...
namespace IronyModManager.Parser.Default
{
    ...
    /// </summary>
    internal class FastDefaultParser
    {
        #region Fields
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FastDefaultParser"/> class.
        /// </summary>
        public FastDefaultParser()
        {
            codeParser = DIResolver.Get<ICodeParser>();
        }
                ...
                if (!openBrackets.HasValue)
                {
                    ...
                    else if (line.Trim().Contains(Constants.Scripts.VariableSeparatorId))
                    {
                        ...
                        if (cleaned.Contains(Constants.Scripts.NamespaceId, StringComparison.OrdinalIgnoreCase))
                        {
                            ...
                            definition.ValueType = Common.ValueType.Namespace;
                        }
                        else
                        {
                            definition.Id = id;
                            definition.ValueType = Common.ValueType.Variable;
                        }
