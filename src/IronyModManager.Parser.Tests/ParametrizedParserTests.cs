...
namespace IronyModManager.Parser.Tests
{
    ...
    public class ParametrizedParserTests
    {
        ...
        public void GetObjectId_should_understand_conditional_switch_parse()
        {
            ...
            sb2.AppendLine(@"FROM = { NOT = { has_fleet_flag = acot_emissary_beam_delay } }");
            sb2.AppendLine(@"}");
            sb2.AppendLine(@"custom_tooltip = {");
            ...
            sb2.AppendLine(@"OR = {");
            sb2.AppendLine(@"NOT = { exists = space_owner }");
            sb2.AppendLine(@"AND = {");
            sb2.AppendLine(@"exists = space_owner");
            sb2.AppendLine(@"space_owner = { is_same_value = from.owner }");
            sb2.AppendLine(@"}");
            sb2.AppendLine(@"}");
