...
{
    /// <summary>
    /// Class StellarisRandomNamesParserTests.
    /// </summary>
    public class StellarisKeyParserTests
    {
        ...
        public void Parse_should_yield_results()
        {
            ...
            var args = new ParserArgs()
            {
                ...
                File = "common\\random_names\\fake.txt",
            ...
            for (int i = 0; i < 3; i++)
            {
                ...
                result[i].File.Should().Be("common\\random_names\\fake.txt");
                switch (i)
                {
                    case 0:
                ...
                result[i].Type.Should().Be("common\\random_names\\txt");
            }
        }
    }
}
