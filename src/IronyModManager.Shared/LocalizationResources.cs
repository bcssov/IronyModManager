...
namespace IronyModManager.Shared
{
    public static class LocalizationResources
    {
        ...
        public static class FileDialog
        {
            ...
            {
                public const string Prefix = "FileDialog." + nameof(Folders) + ".";
        ...
        public static class Collection_Mods
        {
            ...
            {
                public const string Prefix = "Collection_Mods." + nameof(ImportPrompt) + ".";
                public const string Title = Prefix + "Title";
                public const string Message = Prefix + "Message";
            }
        ...
        public static class Conflict_Solver
        {
            ...
            {
                public const string Prefix = "Conflict_Solver." + nameof(PriorityReason) + ".";
        ...
        public static class Notifications
        {
            ...
            {
                public const string Prefix = "Notifications." + nameof(CollectionApplied) + ".";
                public const string Title = Prefix + "Title";
                public const string Message = Prefix + "Message";
            }
            public static class CollectionNotApplied
            {
                public const string Prefix = "Notifications." + nameof(CollectionNotApplied) + ".";
                public const string Title = Prefix + "Title";
                public const string Message = Prefix + "Message";
            }
