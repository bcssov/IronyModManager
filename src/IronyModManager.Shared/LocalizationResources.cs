    ...
    public static class LocalizationResources
    {
        ...
        public static class FileDialog
        {
            ...
            public static class Folders
            {
                ...
                public const string Videos = Prefix + "Videos";
        ...
        {
            public const string Prefix = "Themes.";
            public const string Name = Prefix + "Name";
        ...
        public static class Installed_Mods
        {
            ...
            {
                public const string Prefix = "Installed_Mods.InvalidMods.";
                public const string Title = Prefix + "Title";
                public const string Message = Prefix + "Message";
            }
        }
        public static class Collection_Mods
        {
            ...
            public static class ImportOther
            {
                ...
                public const string ParadoxLauncherBeta = Prefix + "ParadoxLauncherBeta";
            ...
            public static class ExportOther
            {
                ...
                public const string ParadoxLauncherJson = Prefix + "ParadoxLauncherJson";
                public const string ParadoxLauncherJson202110 = Prefix + "ParadoxLauncherJson202110";
                public const string Close = Prefix + "Close";
            }
        ...
        {
            public const string Prefix = "Conflict_Solver.";
            ...
            {
                public const string Prefix = "Conflict_Solver.InvalidConflicts.";
                public const string Name = Prefix + "Name";
            ...
            public static class ContextMenu
            {
                ...
                public const string ToggleCompare = Prefix + "ToggleCompare";
            }
            public static class EditorContextMenu
            {
                public const string Prefix = "Conflict_Solver.EditorContextMenu.";
                public const string Copy = Prefix + "Copy";
                public const string Cut = Prefix + "Cut";
                public const string Delete = Prefix + "Delete";
                public const string Paste = Prefix + "Paste";
        ...
        {
            public const string Prefix = "ConflictIgnore.";
            public const string Save = Prefix + "Save";
            public const string Cancel = Prefix + "Cancel";
            public const string Watermark = Prefix + "Watermark";
        }
        ...
        public static class Notifications
        {
            ...
            {
                public const string Prefix = "Notifications.CollectionCreated.";
                public const string Title = Prefix + "Title";
                public const string Message = Prefix + "Message";
            }
            ...
            {
                public const string Prefix = "Notifications.CollectionExists.";
                public const string Title = Prefix + "Title";
                public const string Message = Prefix + "Message";
            }
            public static class CollectionExported
            {
                public const string Prefix = "Notifications.CollectionExported.";
                public const string Title = Prefix + "Title";
                public const string Message = Prefix + "Message";
            }
            public static class CollectionImported
            {
                public const string Prefix = "Notifications.CollectionImported.";
                public const string Title = Prefix + "Title";
                public const string Message = Prefix + "Message";
            }
            public static class CollectionApplied
            {
                public const string Prefix = "Notifications.CollectionApplied.";
                public const string Title = Prefix + "Title";
                public const string Message = Prefix + "Message";
            }
            ...
            {
                public const string Prefix = "Notifications.DescriptorsRefreshed.";
                public const string Title = Prefix + "Title";
                public const string Message = Prefix + "Message";
            }
            public static class DescriptorsLocked
            {
                public const string Prefix = "Notifications.DescriptorsLocked.";
                public const string Title = Prefix + "Title";
                public const string Message = Prefix + "Message";
            }
            public static class DescriptorsUnlocked
            {
                public const string Prefix = "Notifications.DescriptorsUnlocked.";
                public const string Title = Prefix + "Title";
                public const string Message = Prefix + "Message";
            }
            public static class NewDescriptorsChecked
            {
                public const string Prefix = "Notifications.NewDescriptorsChecked.";
                public const string Title = Prefix + "Title";
                public const string Message = Prefix + "Message";
            }
            public static class CollectionRenamed
            {
                public const string Prefix = "Notifications.CollectionRenamed.";
                public const string Title = Prefix + "Title";
                public const string Message = Prefix + "Message";
            }
        ...
        {
            public const string Prefix = "Descriptor_Actions.";
